combinedVolumeAreaLoop <- function(infile, outfile){
  ...
  p <- ggplot2::ggplot() + ggplot2::scale_colour_manual(values = c("red","blue")) +
    ...
    ggplot2::ylab('Fractional water area') + ggplot2::coord_equal(ratio = 1) +
    ...
    ggplot2::facet_grid(. ~ Resolution) + ggplot2::theme_gray(18) +
