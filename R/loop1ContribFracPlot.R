#' Plots loop1 contributing fraction hysteresis
#'
...
loop1ContribFracPlot <- function(orderedAreaVol, extend=TRUE, normalize=TRUE,  outfile='', N=1){
  ...
  p <- contributingAreaHysteresisPlot(curve1, curve2, extend=TRUE, normalize=TRUE, outfile='', N=1)
